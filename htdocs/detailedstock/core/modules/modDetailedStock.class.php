...
/**
 *  \defgroup   detailedStock     Module DetailedStock
 *  \brief      Detailed stocks.
 *  \file       htdocs/detailedstock/core/modules/modDetailedStock.class.php
 *  \ingroup    detailedstock
 *  \brief      Description and activation file for module detailedStock
 */
include_once(DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php");

/**
 *  Description and activation class for module detailedStock
 */
class modDetailedStock extends DolibarrModules
{
    ...
    public function modDetailedStock($db)
    {
        ...
        $this->rights_class = 'detailedStock';
        ...
        $this->description = $langs->trans("ModDetailedStockDescription");
        ...
        // Example: $this->const=array(0=>array('detailedStock_MYNEWCONST1','chaine','myvalue','This is a constant to add',1),
        //                             1=>array('detailedStock_MYNEWCONST2','chaine','myvalue','This is another constant to add',0)
        // );
        $this->const = array();

        // Array to add new pages in new tabs
        // Example: $this->tabs = array('objecttype:+tabname1:Title1:langfile@detailedStock:$user->rights->detailedStock->read:/detailedStock/mynewtab1.php?id=__ID__', // To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:langfile@detailedStock:$user->rights->othermodule->read:/detailedStock/mynewtab2.php?id=__ID__',   // To add another new tab identified by code tabname2
        ...
        /* Example:
          ...
          'langs'=>'detailedStock@detailedStock',
          ...
          'tabcond'=>array($conf->detailedStock->enabled,$conf->detailedStock->enabled,$conf->detailedStock->enabled)   // Condition to show each dictionnary
          );
         */
        ...
        //                          'titre'=>'detailedStock top menu',
        //                          'mainmenu'=>'detailedStock',
        //                          'leftmenu'=>'detailedStock',
        //                          'url'=>'/detailedStock/pagetop.php',
        //                          'langs'=>'mylangfile',                      // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
        //                          'position'=>100,
        //                          'enabled'=>'$conf->detailedStock->enabled', // Define condition to show or hide menu entry. Use '$conf->detailedStock->enabled' if entry must be visible if module is enabled.
        //                          'perms'=>'1',                               // Use 'perms'=>'$user->rights->detailedStock->level1->level2' if you want your menu with a permission rules
        //                          'target'=>'',
        //                          'user'=>2);                                 // 0=Menu for internal users, 1=external users, 2=both
        // $r++;
        // $this->menu[$r]=array(   'fk_menu'=>'r=0',                           // Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
        //                          'type'=>'left',                             // This is a Left menu entry
        //                          'titre'=>'detailedStock left menu',
        //                          'mainmenu'=>'detailedStock',
        //                          'leftmenu'=>'detailedStock',
        //                          'url'=>'/detailedStock/pagelevel1.php',
        //                          'langs'=>'mylangfile',                      // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
        //                          'position'=>100,
        //                          'enabled'=>'$conf->detailedStock->enabled', // Define condition to show or hide menu entry. Use '$conf->detailedStock->enabled' if entry must be visible if module is enabled.
        //                          'perms'=>'1',                               // Use 'perms'=>'$user->rights->detailedStock->level1->level2' if you want your menu with a permission rules
        ...
        //                          'leftmenu'=>'detailedStock',
        //                          'url'=>'/detailedStock/pagelevel2.php',
        //                          'langs'=>'mylangfile',                      // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
        //                          'position'=>100,
        //                          'enabled'=>'$conf->detailedStock->enabled', // Define condition to show or hide menu entry. Use '$conf->detailedStock->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
        //                          'perms'=>'1',                               // Use 'perms'=>'$user->rights->detailedStock->level1->level2' if you want your menu with a permission rules
        //                          'target'=>'',
        //                          'user'=>2);                                 // 0=Menu for internal users, 1=external users, 2=both
        // $r++;
     ...
     *      and create data commands must be stored in directory /detailedStock/sql/
