...
if (empty($conf->db->character_set))  				$conf->db->character_set='utf8mb4';
if (empty($conf->db->dolibarr_main_db_collation))  	$conf->db->dolibarr_main_db_collation='utf8mb4_unicode_ci';
